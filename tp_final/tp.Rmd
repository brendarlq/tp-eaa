...
plot(basis,xlab="horarios",ylab="valor base",main="Base B-Spline con 15 nodos",col=1:10 )
...
```{r}
# Calcular la derivada del objeto funcional frecuencia_fd
frecuencia_fd_deriv <- fdata.deriv(frecuencia_fd)

# Visualizar la derivada
plot(frecuencia_fd_deriv, main = "Derivada de la Frecuencia de Delitos")
