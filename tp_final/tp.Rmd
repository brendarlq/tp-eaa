...
franja_horaria_matrix <- delitos_agrupados %>%
  pivot_wider(names_from = franja, values_from = frecuencia, values_fill = 0) %>%
  column_to_rownames(var = "fecha") %>%
  as.matrix()

# Dimensiones de la matriz
print(dim(franja_horaria_matrix))


tipo_delito_matrix <- delitos_agrupados_tipo %>%
  pivot_wider(names_from = tipo, values_from = frecuencia, values_fill = 0) %>%
  column_to_rownames(var = "fecha") %>%
  as.matrix()

# Dimensiones de la matriz
print(dim(tipo_delito_matrix))
